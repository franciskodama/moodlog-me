    ...
    <>
      <div className='p-10'>
        ...
        <p className='mb-5'>
          ...
          track, understand, and reflect on your moods effortlessly. Seamlessly
        ...
        <ul>
          ...
          <li>
            ...
            time. Our user-friendly interface allows you to view your mood
            history and trends at a glance.
          </li>

          <li>
            Insightful Analytics: Gain a deeper understanding of your emotional
            landscape through interactive charts and graphs. Discover patterns
            and correlations that you might have never noticed before.
          </li>
          <li>
          ...
          <li>
            Private and Secure: Safeguard your personal thoughts and emotions
            with end-to-end encryption. Your data is confidential, and you have
