...
export const moods = [
  {
    ...
    icon: <AngryIcon className='h-8 w-8' strokeWidth='1.4px' fill='#ffdc02' />,
  },
  {
    id: 2,
    title: 'Whimsical Woe',
    ...
    icon: <FrownIcon className='h-8 w-8' strokeWidth='1.4px' fill='#ffdc02' />,
  },
  {
    id: 3,
    ...
    icon: <MehIcon className='h-8 w-8' strokeWidth='1.4px' fill='#ffdc02' />,
  },
  {
    id: 4,
    title: 'Cozy Respite',
    ...
    icon: <SmileIcon className='h-8 w-8' strokeWidth='1.4px' fill='#ffdc02' />,
  },
  {
    id: 5,
    title: 'Fiery Fury',
